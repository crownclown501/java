...
public class P1 extends Proceso {
    public P1(Grafo grafo, Nodo inicio, Nodo fin) {
    ...
    protected void recorrerGrafo(Nodo inicio, Nodo fin) {
        ...
        while (nodoActual != null && !nodoActual.equals(fin)) {
            System.out.println("P1 está en " + nodoActual.getNombre());
            ...
            for (Map.Entry<String, Nodo> entry : aristas.entrySet()) {
                ...
                break; // Tomamos la primera arista
            }

            if (siguienteNodo != null) {
                System.out.println("P1 pasa por " + siguienteArista);
        ...
        System.out.println("P1 ha llegado al fin del proceso en " + fin.getNombre());
    }
}
