...
public class P3 extends Proceso {
    public P3(Grafo grafo, Nodo inicio, Nodo fin) {
    ...
    protected void recorrerGrafo(Nodo inicio, Nodo fin) {
        ...
        while (nodoActual != null && !nodoActual.equals(fin)) {
            System.out.println("P3 está en " + nodoActual.getNombre());
            ...
            if (siguienteNodo != null) {
                System.out.println("P3 pasa por " + siguienteArista);
        ...
        System.out.println("P3 ha llegado al fin del proceso en " + fin.getNombre());
    }
}
