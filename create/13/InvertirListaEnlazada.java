...
public class InvertirListaEnlazada {
   ...
   private Nodo ultimo; //ultimo vamos a posicionarlo al final
    ...
    public void invertir()     //[2]<-[3]->[4]->[5]->[7]->[9]->[11]->[12]->[23]->null
    {
       
        Nodo aux=primero;
        Nodo ayuda=null;
        while (aux!=null) {
            if (aux.info<aux.liga.info) {
				ayuda=aux;
				aux.liga=ayuda;
            }
			aux=aux.liga;
    ...
    public void recorrer()
   {
    ...
    {
    	InvertirListaEnlazada L = new InvertirListaEnlazada();
        L.insertar(0);
		L.insertar(10);
    	L.insertar(5);
    	L.insertar(2);
