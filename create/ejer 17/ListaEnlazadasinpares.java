class Nodo
{
	public int info;   // 8 .info 8 03422  info va a ser nuestro helper para saber lo que este dentro del nodo en el que estemos 
	public Nodo liga;//8 
...
public class ListaEnlazadasinpares 
{
   ...
   public void recorrer()
   {
    ...
    {
    	ListaEnlazadasinpares L = new ListaEnlazadasinpares();
