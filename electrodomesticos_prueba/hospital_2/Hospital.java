...
public class Hospital {
    public static void main(String[] args) {
        int opcion,i,k,m,l,opcion1,opcion2,opcion3,opcion4,opcion5,opcion6,opcion7,opcion8;
        boolean bandera;
        ...
        while (opcion != 6) {
            ...
            switch (opcion) {
                ...
                case 2:{
                    if(bandera){
                        ...
                        System.out.println("3:Intendente");
                ...
                case 3:{
                    ...
                    switch(opcion2){
                                ...
                                case 5:{
                                    ...
                                    for(a=0;a<l;a++){
                                        ...
                                        if(numeroDeIntendente==i2.numeroDeIntendente){
                                            ...
                                            ((Intendente)empleadosIntendentes[a]).nombreDeLaEmpresa=nombreDeLaEmpresa;
                                            }
                                            a=l;
                                        }
                                    }
                        ...
                        case 4:{
                            ...
                            System.out.println("4:Direccion");
                            System.out.println("5:Salario");
                            System.out.println("6:conntrato");
                            opcion3= leer.nextInt();
                            while (opcion3<1 || opcion3>6)
                                {
                                    System.out.println("Ingreso a la opcion Medico(a)");
                ...
                if (bandera)
                {
                    ...
                    System.out.println("Ingrese el numero de la opcion del empleado que desea eliminar");
                    System.out.println("1:Intendente");
                    System.out.println("2:Medico(a)");
                    System.out.println("3:Enfermero(a)");
                    System.out.println("4:Administrativo(a)");
                    ...
                    while(opcion5<1 || opcion5>4){
                        System.out.println("Ingreso a la opcion Eliminar trabjador");
                        System.out.println("Ingrese el numero de la ocpion de empleado que desea dar de baja");
                        System.out.println("1:Intendente");
                        System.out.println("2:Medico(a)");
                        System.out.println("3:Enfermero(a)");
                        System.out.println("4:Administrativo(a)");
                    ...
                    switch (opcion5) {
                        case 1:
                            int numeroDeIntendente;
                                System.out.println("Ingreso a la opcion borrar intendente:");
                                ...
                                for(a=0;a<l;a++){
                                    ...
                                    if(numeroDeIntendente==i2.numeroDeIntendente){
                                        ...
                                        i2.direccion=" ";
                                        i2.salario= 0;
                                        i2.nombreDeLaEmpresa=" ";
                                        i2.numeroDeIntendente=0;
                                        empleadosIntendentes[a]= (Empleado)i2;
                                        i2.escritura();
                                        i2.escritura(i2);
                                        System.out.println("\n");
                                    }
                        ...
                        case 2:
                                System.out.println("Ingreso a la opcion borra medico:");
                                System.out.println("Ingrese el numero de Medico(a) del Medico(a) que desea modificar");
                                numeroDeMedico=leer.nextInt();
                                for(a=0;a<i;a++){
                                    Medico m2=(Medico) empleadosMedicos[a];
                                    if(numeroDeMedico==m2.numeroDeMedico){
                                        ...
                                        m2.salario= 0;
                                        m2.numeroDeMedico=0;
                                        m2.departamentoGinecologia=false;
                                        m2.departamentoMedicinaGeneral=false;
                                        m2.departamentoOftalmologia=false;
                                        m2.departamentoPediatria=false;
                                        empleadosMedicos[a]= (Empleado)m2;
                                        m2.escritura();
                                        m2.escritura(m2);
                                        System.out.println("\n");
                                    }
                        ...
                        case 3:
                        int numeroDeEnfermera;
                            System.out.println("Ingreso a la opcion borra Enfermera:");
                            System.out.println("Ingrese el numero de Enfermera(a) del Enfermera(a) que desea modificar");
                            numeroDeEnfermera=leer.nextInt();
                            for(a=0;a<k;a++){
                                Enfermera e2=(Enfermera) empleadosEnfermeros[a];
                                if(numeroDeEnfermera==e2.numeroDeEnfermera){
                                    ...
                                    e2.direccion=" ";
                                    e2.salario= 0;
                                    e2.numeroDeEnfermera=0;
                                    e2.departamentoGinecologia=false;
                                    e2.departamentoMedicinaGeneral=false;
                                    e2.departamentoOftalmologia=false;
                                    e2.departamentoPediatria=false;
                                    empleadosEnfermeros[a]= (Empleado)e2;
                                    e2.escritura();
                                    e2.escritura(e2);
                                    System.out.println("\n");
                                }
                        ...
                        case 4:
                        int numeroDeAdministrativo;
                            System.out.println("Ingreso a la opcion borra Administrativo:");
                            System.out.println("Ingrese el numero de Administrativo(a) del Administrativo(a) que desea modificar");
                            numeroDeAdministrativo=leer.nextInt();
                            for(a=0;a<m;a++){
                                Administrativo a2=(Administrativo) empleadosAdministrativos[a];
                                if(numeroDeAdministrativo==a2.numeroDeAdministrativo){
                                    ...
                                    a2.salario=0;
                                    a2.direccion=" ";
                                    a2.sindicalizado=false;
                                    a2.personalDeConfianza=false;
                                    empleadosAdministrativos[a]= (Empleado)a2;
                                    a2.escritura();
                                    a2.escritura(a2);
                                    System.out.println("\n");
                                }
            ...
            case 5:
                ...
                if (bandera)
                {
                    ...
                    System.out.println("Ingreso a la opcion Mostrar trabjador");
                    System.out.println("Ingrese el numero de la opcion que desea mostrar");
                    System.out.println("1:Por Departamento");
                    System.out.println("2:Por Area");
                    System.out.println("salir");
                    opcion6=leer.nextInt();
                    while(opcion6<1 || opcion6>2){
                        System.out.println("Ingreso a la opcion Mostrar trabjador");
                        System.out.println("Ingrese el numero de la opcion que desea mostrar");
                        System.out.println("1:Por Departamento");
                        System.out.println("2:Por Area");
                    ...
                    switch (opcion6) {
                        case 1:
                            ...
                            System.out.println("Ingreso a la opcion Mostrar trabjador por departamento");
                            System.out.println("Ingrese el numero de la opcion del empleado que desea mostrar");
                            System.out.println("1:Ginecologia");
                            System.out.println("2:Oftalmologia");
                            System.out.println("3:Medicina General");
                            System.out.println("4:Pediatria");
                            opcion7=leer.nextInt();
                            while(opcion7<1 || opcion7>4){
                            System.out.println("Ingreso a la opcion Mostrar trabjador por area");
                            System.out.println("Ingrese el numero de la opcion del empleado que desea mostrar");
                            System.out.println("1:Ginecologia");
                            System.out.println("2:Oftalmologia");
                            System.out.println("3:Medicina General");
                            ...
                            switch (opcion7) {
                                case 1:
                                    System.out.println("Ingreso a la opcion Ginecologia");
                                    System.out.println("el numero de empleados de este departamento es:"+(i+k));
                                    for(a=0;a<empleadosMedicos.length;a++)
                                    {

                                        Medico m1=(Medico) empleadosMedicos[a];
                                        if (m1.departamentoGinecologia==true) {
                                            m1.escritura();
                                            m1.escritura(m1);
                                            System.out.println("\n");
                                        }
                                    ...
                                    for(a=0;a<empleadosEnfermeros.length;a++)
                                    {

                                        Enfermera e1=(Enfermera) empleadosEnfermeros[a];
                                        if (e1.departamentoGinecologia==true) {
                                            e1.escritura();
                                            e1.escritura(e1);
                                            System.out.println("\n");
                                        }
                                    ...
                                    break;
                                case 2:
                                    System.out.println("Ingreso a la opcion Oftalmologia");
                                    System.out.println("el numero de empleados de este departamento es:"+(i+k));
                                    for(a=0;a<empleadosMedicos.length;a++)
                                    {

                                        Medico m1=(Medico) empleadosMedicos[a];
                                        if (m1.departamentoOftalmologia==true) {
                                            m1.escritura();
                                            m1.escritura(m1);
                                            System.out.println("\n");
                                        }
                                    ...
                                    for(a=0;a<empleadosEnfermeros.length;a++)
                                    {
                                        ...
                                        Enfermera e1=(Enfermera) empleadosEnfermeros[a];
                                        if (e1.departamentoOftalmologia==true) {
                                            e1.escritura();
                                            e1.escritura(e1);
                                            System.out.println("\n");
                                        }
                                    ...
                                    break;
                                case 3:
                                    System.out.println("Ingreso a la opcion Medicina General");
                                    System.out.println("el numero de empleados de este departamento es:"+(i+k));
                                    for(a=0;a<empleadosMedicos.length;a++)
                                    {

                                        Medico m1=(Medico) empleadosMedicos[a];
                                        if (m1.departamentoMedicinaGeneral==true) {
                                            m1.escritura();
                                            m1.escritura(m1);
                                            System.out.println("\n");
                                        }
                                    ...
                                    for(a=0;a<empleadosEnfermeros.length;a++)
                                    {
                                        ...
                                        Enfermera e1=(Enfermera) empleadosEnfermeros[a];
                                        if (e1.departamentoMedicinaGeneral==true) {
                                            e1.escritura();
                                            e1.escritura(e1);
                                            System.out.println("\n");
                                        }
                                    ...
                                    break;
                                case 4:
                                    System.out.println("Ingreso a la opcion Pediatria");
                                    System.out.println("el numero de empleados de este departamento es:"+(i+k));
                                    for(a=0;a<empleadosMedicos.length;a++)
                                    {

                                        Medico m1=(Medico) empleadosMedicos[a];
                                        if (m1.departamentoPediatria==true) {
                                            m1.escritura();
                                            m1.escritura(m1);
                                            System.out.println("\n");
                                        }
                                    ...
                                    for(a=0;a<empleadosEnfermeros.length;a++)
                                    {
                                        ...
                                        Enfermera e1=(Enfermera) empleadosEnfermeros[a];
                                        if (e1.departamentoPediatria==true) {
                                            e1.escritura();
                                            e1.escritura(e1);
                                            System.out.println("\n");
                                        }
                        ...
                        case 2:
                            ...
                            switch (opcion8) {
                                case 1:
                                    System.out.println("Ingreso a la opcion Intendente");
                                    System.out.println("el numero de empleados en esta area es:"+l);
                                    for(a=0;a<empleadosIntendentes.length;a++)
                                    {

                                        Intendente i1=(Intendente) empleadosIntendentes[a];
                                        i1.escritura();
                                        i1.escritura(i1);
                                        System.out.println("\n");
                                    }
                                    break;
                                case 2:
                                    System.out.println("Ingreso a la opcion Medico");
                                    System.out.println("el numero de empleados en esta area es:"+i);
                                    for(a=0;a<empleadosMedicos.length;a++)
                                    {
                                    ...
                                    break;
                                case 3:
                                    System.out.println("Ingreso a la opcion Enfermera");
                                    System.out.println("el numero de empleados en esta area es:"+k);
                                    for(a=0;a<empleadosEnfermeros.length;a++)
                                    {
                                    ...
                                    break;
                                case 4:
                                    System.out.println("Ingreso a la opcion Aministrador");
                                    System.out.println("el numero de empleados en esta area es:"+m);
                                    for(a=0;a<empleadosAdministrativos.length;a++)
                                    {

                                        Administrativo a1=(Administrativo) empleadosAdministrativos[a];
                                        a1.escritura();
                                        a1.escritura(a1);
                                        System.out.println("\n");
                                    }
